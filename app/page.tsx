...
export default function Dashboard() {
  ...
  const userName = user?.displayName || "player"; // This would normally come from your authentication system
        ...
        <div className="container mx-auto p-12  items-center">
          ...
          >
            <TabsList className="grid w-full grid-cols-2 mb-4">
              <TabsTrigger
                value="store"
                className="text-medium md:text-lg text-purple-700 font-semibold"
              >
                Store
              </TabsTrigger>
              <TabsTrigger
